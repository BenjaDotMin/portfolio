...
function Image({ className, clickable, amount = 5, clickdepth = 2 }) {
    ...
    return (
        <div onMouseDown={() => setMouseDown(b => !b)} onMouseUp={() => setMouseDown(b => !b)} onMouseLeave={() => setMouseDown(false)} className={`ortho__image __3d ${className ? className : ""} ${clickable ? "--clickable" : ""}`}>
